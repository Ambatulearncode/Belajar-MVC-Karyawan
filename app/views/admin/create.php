<div class="max-w-4xl mx-auto">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500">Tambah Admin</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-gray-600 mt-2">Buat akun admin baru untuk mengelola sistem</p>
                </div>
                <a href="<?= url('/?url=karyawan') ?>"
        ...
        <div class="bg-white rounded-xl card-shadow p-6 md:p-8">
            <form method="POST" action="?url=admin&action=store" class="space-y-6">
                <!-- Username Field -->
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Tips Pengisian Form Admin</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            ...
                            <li>Admin yang dibuat akan memiliki akses penuh ke data karyawan</li>
                        </ul>
                    </div>
                </div>
            </div>
