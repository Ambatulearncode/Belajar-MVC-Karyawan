<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl card-shadow p-6 md:p-8">
        <form method="POST" action="?url=karyawan&action=update&id=<?= $karyawan['id'] ?>" class="space-y-6">
            <!-- Nama Field -->
            <div class="pb-4 border-b border-gray-200">
                ...
                <input type="text"
                    id="nama"
                    name="nama"
                    value="<?= isset($old['nama']) ? htmlspecialchars($old['nama']) : htmlspecialchars($karyawan['nama']) ?>"
            ...
            <div class="pb-4 border-b border-gray-200">
                ...
                <select id="jabatan"
                    ...
                    <option value="Manager" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Manager' ? 'selected' : '' ?>>Manager</option>
                    <option value="Supervisor" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Supervisor' ? 'selected' : '' ?>>Supervisor</option>
                    <option value="Staff IT" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Staff IT' ? 'selected' : '' ?>>Staff IT</option>
                    <option value="HRD" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'HRD' ? 'selected' : '' ?>>HRD</option>
                    <option value="Accounting" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Accounting' ? 'selected' : '' ?>>Accounting</option>
                    <option value="Marketing" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Marketing' ? 'selected' : '' ?>>Marketing</option>
                    <option value="Staff Admin" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Staff Admin' ? 'selected' : '' ?>>Staff Admin</option>
                    <option value="Operator" <?= (isset($old['jabatan']) ? $old['jabatan'] : $karyawan['jabatan']) == 'Operator' ? 'selected' : '' ?>>Operator</option>
                </select>
            </div>
            ...
            <div class="pb-4 border-b border-gray-200">
                ...
                <div class="relative">
                    ...
                    <input type="number"
                        id="gaji"
                        name="gaji"
                        value="<?= isset($old['gaji']) ? htmlspecialchars($old['gaji']) : $karyawan['gaji'] ?>"
            ...
            <div class="pb-4">
                ...
                <input type="date"
                    id="tanggal_masuk"
                    name="tanggal_masuk"
                    value="<?= isset($old['tanggal_masuk']) ? htmlspecialchars($old['tanggal_masuk']) : htmlspecialchars($karyawan['tanggal_masuk'] ?? '') ?>"
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-blue-800">Tips Update Data</h3>
                <div class="mt-2 text-sm text-blue-700">
                    <ul class="list-disc pl-5 space-y-1">
                        ...
                        <li>Data akan langsung tersimpan setelah tombol "Update Data" ditekan</li>
